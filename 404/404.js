class Game {
  ...
  generateTweet() {
      ...
      window.open("https://twitter.com/intent/tweet?url=https://codepen.io/gregh/full/yVLOyO&amp;text=I scored "+ this.score +" points on My Balls! Can you beat my score?&amp;via=greghvns&amp;hashtags=myballs", "TweetWindow", "width=600px,height=300px,top=" + top + ",left=" + left);
  }
